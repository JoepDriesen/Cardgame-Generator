...
def generate():
    ...
    parser.add_argument( '-r', '--card_resolution', action='store', default=72, help='The ppi (pixels-per-inch) resolution of the template images and thus of the generated card images.' )
